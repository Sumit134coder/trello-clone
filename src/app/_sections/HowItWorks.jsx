      ...
      <div className="max-w-350 mx-auto w-full">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-[#0c0c0c]/10">
          {[
            ...
            <article
              key={item.label}
              className="bg-text-500 p-10 md:p-14 flex flex-col gap-6 group hover:bg-[#0c0c0c] hover:text-text-500 transition-colors duration-300"
            >
              <span className="text-xs tracking-widest uppercase text-text-500">
                {item.label}
              </span>
